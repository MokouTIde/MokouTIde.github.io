...
In practice, it is important to note that discretizing the Hamiltonian dynamics introduces two free parameters, the step size {{< katex >}}\epsilon{{< /katex >}} and the trajectory length $T\epsilon$, both to be calibrated. As an empirically successful and popular variant of HMC, the "no-U-turn sampler" (NUTS) of Hoffman and Gelman (2014) adapts the value of {{< katex >}}\epsilon{{< /katex >}} based on primal-dual averaging. <a href="#1">[1]</a>
...
<a name="1">[1]</a> [Hoffman, Matthew D., and Andrew Gelman. "The No-U-Turn sampler: adaptively setting path lengths in Hamiltonian Monte Carlo." J. Mach. Learn. Res. 15.1 (2014): 1593-1623.](https://www.jmlr.org/papers/volume15/hoffman14a/hoffman14a.pdf)
